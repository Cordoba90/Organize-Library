class Media {
  ...
  getAverageRating() {
    let raitings =
      this.raitings.reduce((sum, raiting) => sum + raiting) /
      this.raitings.length;
...
const tester = new Media(
  "test title",
  "Crime");
  tester.addraiting(4);
  tester.addraiting(6);
  tester.addraiting(8);
console.log(tester.getAverageRating());
console.log(tester);
...
catalogLibrary.addMedia(
  new Book("History of Violence", "Crime", "Édouard Louis", 224)
);
